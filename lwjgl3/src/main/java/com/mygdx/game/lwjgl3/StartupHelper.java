    ...
    public static boolean startNewJvmIfRequired(boolean redirectOutput) {
        ...
        if (!osName.contains("mac")) {
            if (osName.contains("windows")) {
                //work around lwjgl temp extraction issues on some windows usernames
                String programData = System.getenv("ProgramData");
                if(programData == null) programData = "C:\\Temp\\"; //fallback when programdata env var is missing
        ...
        //native images do not need first-thread restart
        if (!System.getProperty("org.graalvm.nativeimage.imagecode", "").isEmpty()) {
            return false;
        }

        //if already on main thread no restart is needed
        ...
        //continue normally if the first-thread flag is already set
        ...
        //restart current app with -XstartOnFirstThread
